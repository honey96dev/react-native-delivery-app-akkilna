    ...
    return (
      ...
      {/* End Header */}  
          ...
          <Tab heading="Pickup">
                      ...
                      <Button onPress={() => this.props.navigation.navigate("MapsView")} style={{marginTop:10, width:'100%', alignContent:'center', justifyContent:'center'}}  success><Text>Start Pickup</Text></Button>
                      </View>
          ...
          <Tab heading="Delivery">
                      ...
                      <Button onPress={() => this.props.navigation.navigate("MapsView")} style={{marginTop:10, width:'100%', alignContent:'center', justifyContent:'center'}}  success><Text>Start Delivery</Text></Button>
            ...
            {/* End Complete Order */}  
             ...
             {/* Price Card */}  
                ...
                <Button onPress={() => this.props.navigation.navigate("Cancelled")} style={{marginTop:10, width:'100%', alignContent:'center', justifyContent:'center'}} danger><Text>Cancelled</Text></Button>
