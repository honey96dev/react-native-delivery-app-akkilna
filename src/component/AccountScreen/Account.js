...
>
  ...
  <Content>
        ...
        <Content style={{marginBottom: 40, marginLeft: 20, marginRight: 20}}>
                <Button onPress={() => this.props.navigation.navigate("Login")} style={{marginTop:20, width:'100%', justifyContent:'center'}} danger><Text style={styles.buttontext}>SignOut</Text></Button>
                </Content>
  </ScrollView>
</ProfileViewParallax>
            </Container>
