...
import {Body, Container, Content, Left, List, ListItem, Text, Thumbnail, View} from "native-base";
    ...
    render() {
        return (
            <Container style={{backgroundColor: "white"}}>
                ...
                >
                    <Image source={require('../../../assets/Images/drawer-logo.png')} style={{
                        height: 90,
                        width: 151,
                        resizeMode: 'contain',
                        marginRight: 15,
                ...
                >
                    <Content>
                        ...
                        <List
                            ...
                            <ListItem style={{marginTop: 10}} onPress={() => {
                                this.props.navigation.navigate("Home");
                            }} icon>
                                <Left>
                                    <Image source={require('../../../assets/Images/home.png')}
                                           style={{height: 24, width: 24, resizeMode: 'contain', marginRight: 15}}/>
                                </Left>
                            ...
                            <ListItem icon>
                                <Left>
                                    <Image source={require('../../../assets/Images/gears.png')}
                                           style={{height: 24, width: 24, resizeMode: 'contain', marginRight: 15}}/>
                                </Left>
                                <Body style={{borderColor: "white",}}>
                            ...
                            <ListItem icon>
                                <Left>
                                    <Image source={require('../../../assets/Images/akilna-white.png')}
                                           style={{height: 24, width: 24, resizeMode: 'contain', marginRight: 15}}/>
                                </Left>
                                <Body style={{borderColor: "white",}}>
